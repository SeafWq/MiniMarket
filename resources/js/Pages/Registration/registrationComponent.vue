                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4">
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" v-on:click="saveUser()">Register</button>
                                        </div>
...
<script setup>
    ...
    const user = ref({}); // Используем ref для управления состоянием
    const errors = ref({});
    ...
    const saveUser = async () => {
        try {
            ...
            toastr.success('Yep');
            user.value = {}; // Обновляем состояние
        } catch (error) {
